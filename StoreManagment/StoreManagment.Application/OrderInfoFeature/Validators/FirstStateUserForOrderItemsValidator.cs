...
{
    public class FirstStateUserForOrderItemsValidator : AbstractValidator<Commands.FirstStateUserForOrderItemsCommand>
    {
        public FirstStateUserForOrderItemsValidator() : base()
        {
