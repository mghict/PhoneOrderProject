...
namespace BillManagement
{
    public static class DependencyContainer : object
    {
        ...
        {
			services.AddTransient<Application.Token.ITokenCreate, Application.Token.TokenCreate>(current =>
			{
				string _Key =
					configuration
					.GetSection(key: "Key")
				...
				return new Application.Token.TokenCreate(_Key, _Issuer,_userName,_password);
            ...
            services.AddMediatR
                (typeof(Application.BillFeature.Commands.GetOrderDetailCommand).GetTypeInfo().Assembly);
            
            //services.AddAutoMapper(typeof(Application.ApplicationInfo.MappingProfile).GetTypeInfo().Assembly);
            // **************************************************
