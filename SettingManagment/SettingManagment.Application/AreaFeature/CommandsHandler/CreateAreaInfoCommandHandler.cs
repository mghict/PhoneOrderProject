...
{
    public class CreateAreaInfoCommandHandler :
        MediatR.IRequestHandler<Commands.CreateAreaInfoCommand, FluentResults.Result<int>>
    {
        protected AutoMapper.IMapper Mapper { get; }
        protected Persistence.IUnitOfWork UnitOfWork { get; }

        public CreateAreaInfoCommandHandler(IMapper mapper, IUnitOfWork unitOfWork)
        {
            Mapper = mapper;
            UnitOfWork = unitOfWork;
        }

        public async Task<FluentResults.Result<int>> Handle(Commands.CreateAreaInfoCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var inActive = await UnitOfWork.AreaInfoRepository.InsertAsync(entity);
