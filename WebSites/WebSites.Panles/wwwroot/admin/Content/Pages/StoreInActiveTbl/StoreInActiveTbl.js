...
function loadData(pagenumber) {
    var url = '/Admin/StoreInActiveData_Paging';
...
function Add() {
    ...
    $.ajax({
        type: "POST",
        url: '/Admin/StoreInActiveData_Insert',
        data: formData,
        dataType: 'json',
        contentType: false,
        processData: false,
...
function getbyID(iD) {
    var url = '/Admin/StoreInActiveData_GetByID';
...
function Update() {
    ...
    $.ajax({
        type: "POST",
        url: '/Admin/StoreInActiveData_Update',
        data: formData,
        dataType: 'json',
        contentType: false,
        processData: false,
...
function Delele(ID) {
    ShowConfirm('توجه', 'آیا مایل به حذف رکورد می باشید ؟',
        function myfunction() {
            var url = '/Admin/StoreInActiveData_Delete'
            var data = JSON.stringify({ "id": ID });
