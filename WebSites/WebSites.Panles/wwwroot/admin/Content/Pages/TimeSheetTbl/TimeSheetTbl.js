...
function loadData(pagenumber) {
    var url = '/Admin/TimeSheetData_Paging';
...
function Add() {
    ...
    $.ajax({
        type: "POST",
        url: '/Admin/TimeSheetData_Insert',
        data: formData,
        dataType: 'json',
        contentType: false,
        processData: false,
...
function getbyID(iD) {
    var url = '/Admin/TimeSheetData_GetByID';
...
function Update() {
    ...
    $.ajax({
        type: "POST",
        url: '/Admin/TimeSheetData_Update',
        data: formData,
        dataType: 'json',
        contentType: false,
        processData: false,
...
function Delele(ID) {
    ShowConfirm('توجه', 'آیا مایل به حذف رکورد می باشید ؟',
        function myfunction() {
            var url = '/Admin/TimeSheetData_Delete'
            var data = JSON.stringify({ "id": ID });
