...
{
    public class ResetPassUserValidator : AbstractValidator<Commands.ResetPassUserCommand>
    {
        public ResetPassUserValidator() : base()
        {
            ...
            RuleFor(current => current.CurrentPass)
                .NotEmpty()
                .WithErrorCode("10")
                .WithMessage(BehsamFramework.Resources.Messages.ErrorRequired)
                .NotNull()
