(function () {
    ...
    var sideNavWrapperProductList = $("#sidenavWrapperProductList");
    ...
    $("#suhaNavbarToggler").on("click", function () {
        ...
        sideNavWrapperProductList.removeClass("nav-active");

        sideNavWrapper.addClass("nav-active");
        blackOverlay.addClass("active");
    });

    $("#suhaNavbarTogglerProductList").on("click", function () {

        sideNavWrapper.removeClass("nav-active");

        sideNavWrapperProductList.addClass("nav-active");
        blackOverlay.addClass("active");
    });
    ...
    $("#goHomeBtnProductList").on("click", function () {
        sideNavWrapper.removeClass("nav-active");
        sideNavWrapperProductList.removeClass("nav-active");
        blackOverlay.removeClass("active");
    });
