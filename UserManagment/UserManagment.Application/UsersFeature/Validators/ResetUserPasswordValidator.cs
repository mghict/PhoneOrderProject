...
{
    public class ResetUserPasswordValidator :
        FluentValidation.AbstractValidator<Commands.ResetUserPasswordCommand>
    {
        public ResetUserPasswordValidator() : base()
        {
            RuleFor(current => current.CurrentPassword)
                .NotEmpty()
                .WithErrorCode("10")
