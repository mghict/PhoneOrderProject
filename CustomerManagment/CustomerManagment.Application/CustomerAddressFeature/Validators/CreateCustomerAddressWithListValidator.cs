...
{
    public class CreateCustomerAddressWithListValidator : FluentValidation.AbstractValidator<Commands.CreateCustomerAddressWithListCommand>
    {
        public CreateCustomerAddressWithListValidator():base()
        {
