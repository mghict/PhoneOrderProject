...
{
    public class CreateCustomerPhoneWithListValidator : FluentValidation.AbstractValidator<Commands.CreateCustomerPhoneWithListCommand>
    {
        public CreateCustomerPhoneWithListValidator():base()
        {
